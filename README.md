...
<section class="home" id="home">
    ...
    <div class="socials">
        <ul class="social-icons">
          <li><a class="linkedin" aria-label="LinkedIn" href="https://www.linkedin.com/in/sreejsing/" target="_blank"><i class="fab fa-linkedin"></i></a></li> 
...
<section class="about" id="about">
    ...
    <div class="content">
        ...
        <p>I'm Sreeja Reddy Singidi, a Data Engineer & Analyst based in St. Louis, Missouri. I specialize in transforming complex data into meaningful insights, architecting scalable pipelines, and optimizing big data workflows.
      ...
      <div class="about-containers">
        ...
        <div class="details-container">
          ...
          <div class="article-container">
            ...
            <article>
              <img src="images/skills1.png" alt="Experience icon" class="icon" />
              <div>
                <h3>Python</h3>
                <p>Experienced</p>
              </div>
        ...
        <div class="details-container">
          ...
          <div class="article-container">
            ...
            <article>
              <img src="images/skills9.png" alt="Experience icon" class="icon" />
              <div>
                <h3>Tableau</h3>
                <p>Experienced</p>
              </div>
...
<section class="tech stack" id="Tech Stack">
    ...
    <h2 class="heading"><i class="fas fa-laptop-code"></i> Tech Stack </span></h2>
    <div class="container">
          <div class="row" id="skillsContainer">

            <div class="bar">
              <div class="info">
                <img src="images/skills1.png" height="50" width="50">
                <span>Python</span>
              </div>
            </div>
            <div class="bar">
              <div class="info">
                <img src="images/skills2.png" height="50" width="50">
                <span>SQL</span>
              </div>
            </div>
            <div class="bar">
              <div class="info">
                <img src="images/skills3.png" height="50" width="50">
                <span>Snowflake</span>
              </div>
            </div>
            ...
            <div class="bar">
              <div class="info">
                <img src="images/skills4.png" height="50" width="50">
                <span>R Language</span>
              </div>
            </div>
            <div class="bar">
              <div class="info">
                <img src="images/skills5.png" height="50" width="50">
                <span>AWS</span>
              </div>
            </div>
            <div class="bar">
              <div class="info">
                <img src="images/skills6.png" height="50" width="50">
                <span>Azure</span>
              </div>
            </div>
            <div class="bar">
              <div class="info">
                <img src="images/skills7.png" height="50" width="50">
                <span>GCP</span>
              </div>
            </div>
            <div class="bar">
              <div class="info">
                <img src="images/skills8.png" height="50" width="50">
                <span>PowerBI</span>
              </div>
            </div>
            <div class="bar">
              <div class="info">
                <img src="images/skills9.png" height="50" width="50">
                <span>Tableau</span>
              </div>
            </div>
            <div class="bar">
              <div class="info">
                <img src="images/skills10.png" height="50" width="50">
                <span>Excel</span>
              </div>
            </div>
             Remaining Skills Without Images
            <div class="bar">
                <div class="info">
                  <span>MongoDB</span>
                </div>
...
<section class="Projects" id="Projects">
  ...
  <div class="box-container">
    ...
    <div class="box tilt">
      <img draggable="false" src="images/image.png" alt="" />
      <div class="content">
        <div class="tag">
    ...
    <div class="box tilt">
      <img draggable="false" src="images/hranalyticsfinal.png" alt="" />
      <div class="content">
        <div class="tag">
    ...
    <div class="box tilt">
      <img draggable="false" src="images/loaneligibility.png" alt="" />
      <div class="content">
        <div class="tag">
    ...
    <div class="box tilt">
      ...
      <div class="content">
        ...
        <div class="desc">
          <p>Developed a relational database system to manage car rentals, ensuring efficient handling of customer accounts, orders, and store operations through well-defined entity relationships.</p>
          <div class="btns">
